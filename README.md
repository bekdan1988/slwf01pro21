...
## slwf01pro21-eng:
- removed code comments and added new comments to mark the code, where you can edit it
...
- deleted "name_add_mac_suffix: true" - mdns works again when uploading firmware
